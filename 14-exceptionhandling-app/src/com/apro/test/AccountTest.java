...
import com.apro.Model.InsufficientBalanceException;
import com.apro.Model.InsufficientCurrentBalanceException;
import com.apro.Model.InsufficientSavingsBalanceException;
import com.apro.Model.InvalidCreditAmount;
...
public class AccountTest {
		...
		while(choice != 4) {
			...
			switch(choice) {
				...
				case 2:
					...
					catch(InvalidCreditAmount exception) {
				...
				case 3:
					...
					catch(InsufficientSavingsBalanceException exception) {
						System.out.println(exception.getMessage());
						break;
					}
					catch(InsufficientCurrentBalanceException exception) {
						System.out.println(exception.getMessage());
					}
					break;
			}
	...
	public static void transactionStatus(double value) {
		System.out.println("Transaction Successful ,  Your current balance is : "+value);
	}
}
